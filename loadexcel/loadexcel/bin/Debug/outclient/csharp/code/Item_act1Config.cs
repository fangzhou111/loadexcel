...
public partial class Item_act1Config : ConfigBase
{
private static Item_act1Config _instance;
public Dictionary<int, Item_act1Data> _datas;
public static Item_act1Config Instance
{
get
{
if (_instance == null)
{
_instance = new Item_act1Config();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("Item_act1.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 1244;i++)
{
Item_act1Data data = new Item_act1Data();
...
if (_datas == null)
_datas = new Dictionary<int, Item_act1Data>();
_datas.Add(data.ID,data);
}
br.Close();
fs.Close();
}
public Item_act1Data Get(int newID)
{
