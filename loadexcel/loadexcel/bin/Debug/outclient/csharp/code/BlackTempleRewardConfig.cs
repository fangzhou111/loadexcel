...
{
public class BlackTempleRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class BlackTempleRewardConfig : ConfigBase
{
private static BlackTempleRewardConfig _instance;
public Dictionary<int, Dictionary<int, BlackTempleRewardData>> _datas;
public static BlackTempleRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new BlackTempleRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("BlackTempleReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 506;i++)
{
BlackTempleRewardData data = new BlackTempleRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, BlackTempleRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, BlackTempleRewardData> _dic = new Dictionary<int, BlackTempleRewardData>();
...
public Dictionary<int, BlackTempleRewardData> Get(int newRewardID)
{
...
public BlackTempleRewardData Get(int newRewardID,int newOrder)
{
