...
{
public class CarnivalRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class CarnivalRewardConfig : ConfigBase
{
private static CarnivalRewardConfig _instance;
public Dictionary<int, Dictionary<int, CarnivalRewardData>> _datas;
public static CarnivalRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new CarnivalRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("CarnivalReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 247;i++)
{
CarnivalRewardData data = new CarnivalRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, CarnivalRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, CarnivalRewardData> _dic = new Dictionary<int, CarnivalRewardData>();
...
public Dictionary<int, CarnivalRewardData> Get(int newRewardID)
{
...
public CarnivalRewardData Get(int newRewardID,int newOrder)
{
