...
{
public class GuildProgressRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class GuildProgressRewardConfig : ConfigBase
{
private static GuildProgressRewardConfig _instance;
public Dictionary<int, Dictionary<int, GuildProgressRewardData>> _datas;
public static GuildProgressRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new GuildProgressRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("GuildProgressReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 5;i++)
{
GuildProgressRewardData data = new GuildProgressRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, GuildProgressRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, GuildProgressRewardData> _dic = new Dictionary<int, GuildProgressRewardData>();
...
public Dictionary<int, GuildProgressRewardData> Get(int newRewardID)
{
...
public GuildProgressRewardData Get(int newRewardID,int newOrder)
{
