...
{
public class ArenaGradeRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class ArenaGradeRewardConfig : ConfigBase
{
private static ArenaGradeRewardConfig _instance;
public Dictionary<int, Dictionary<int, ArenaGradeRewardData>> _datas;
public static ArenaGradeRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new ArenaGradeRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("ArenaGradeReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 44;i++)
{
ArenaGradeRewardData data = new ArenaGradeRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, ArenaGradeRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, ArenaGradeRewardData> _dic = new Dictionary<int, ArenaGradeRewardData>();
...
public Dictionary<int, ArenaGradeRewardData> Get(int newRewardID)
{
...
public ArenaGradeRewardData Get(int newRewardID,int newOrder)
{
