...
{
public class DropPackage_act1Data
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class DropPackage_act1Config : ConfigBase
{
private static DropPackage_act1Config _instance;
public Dictionary<int, DropPackage_act1Data> _datas;
public static DropPackage_act1Config Instance
{
get
{
if (_instance == null)
{
_instance = new DropPackage_act1Config();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("DropPackage_act1.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 1216;i++)
{
DropPackage_act1Data data = new DropPackage_act1Data();
...
if (_datas == null)
_datas = new Dictionary<int, DropPackage_act1Data>();
_datas.Add(data.RewardID,data);
}
br.Close();
fs.Close();
}
public DropPackage_act1Data Get(int newRewardID)
{
