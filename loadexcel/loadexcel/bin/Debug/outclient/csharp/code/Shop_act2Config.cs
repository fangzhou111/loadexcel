...
public partial class Shop_act2Config : ConfigBase
{
private static Shop_act2Config _instance;
public Dictionary<int, Shop_act2Data> _datas;
public static Shop_act2Config Instance
{
get
{
if (_instance == null)
{
_instance = new Shop_act2Config();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("Shop_act2.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 5491;i++)
{
Shop_act2Data data = new Shop_act2Data();
...
if (_datas == null)
_datas = new Dictionary<int, Shop_act2Data>();
_datas.Add(data.ID,data);
}
br.Close();
fs.Close();
}
public Shop_act2Data Get(int newID)
{
