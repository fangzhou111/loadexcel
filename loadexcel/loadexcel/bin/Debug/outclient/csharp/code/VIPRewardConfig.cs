...
public partial class VIPRewardConfig : ConfigBase
{
private static VIPRewardConfig _instance;
public Dictionary<int, VIPRewardData> _datas;
public static VIPRewardConfig Instance
{
get
{
if (_instance == null)
...
private void Load()
{
Stream fs = base.Load("VIPReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 64;i++)
{
VIPRewardData data = new VIPRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, VIPRewardData>();
_datas.Add(data.RewardID,data);
}
br.Close();
fs.Close();
}
public VIPRewardData Get(int newRewardID)
{
