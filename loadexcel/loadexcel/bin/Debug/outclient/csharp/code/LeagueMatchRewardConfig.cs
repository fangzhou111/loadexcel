...
{
public class LeagueMatchRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class LeagueMatchRewardConfig : ConfigBase
{
private static LeagueMatchRewardConfig _instance;
public Dictionary<int, Dictionary<int, LeagueMatchRewardData>> _datas;
public static LeagueMatchRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new LeagueMatchRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("LeagueMatchReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 39;i++)
{
LeagueMatchRewardData data = new LeagueMatchRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, LeagueMatchRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, LeagueMatchRewardData> _dic = new Dictionary<int, LeagueMatchRewardData>();
...
public Dictionary<int, LeagueMatchRewardData> Get(int newRewardID)
{
...
public LeagueMatchRewardData Get(int newRewardID,int newOrder)
{
