...
{
public class GuildCampaignRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class GuildCampaignRewardConfig : ConfigBase
{
private static GuildCampaignRewardConfig _instance;
public Dictionary<int, Dictionary<int, GuildCampaignRewardData>> _datas;
public static GuildCampaignRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new GuildCampaignRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("GuildCampaignReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 765;i++)
{
GuildCampaignRewardData data = new GuildCampaignRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, GuildCampaignRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, GuildCampaignRewardData> _dic = new Dictionary<int, GuildCampaignRewardData>();
...
public Dictionary<int, GuildCampaignRewardData> Get(int newRewardID)
{
...
public GuildCampaignRewardData Get(int newRewardID,int newOrder)
{
