...
{
private static ItemConfig _instance;
public Dictionary<int, ItemData> _datas;
...
private void Load()
{
Stream fs = base.Load("Item.bytes");
...
if (_datas == null)
_datas = new Dictionary<int, ItemData>();
_datas.Add(data.ID,data);
}
br.Close();
fs.Close();
}
public ItemData Get(int newID)
{
