...
public partial class CampaignRewardConfig : ConfigBase
{
private static CampaignRewardConfig _instance;
public Dictionary<int, Dictionary<int, CampaignRewardData>> _datas;
public static CampaignRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new CampaignRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("CampaignReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 11574;i++)
{
CampaignRewardData data = new CampaignRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, CampaignRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, CampaignRewardData> _dic = new Dictionary<int, CampaignRewardData>();
...
public Dictionary<int, CampaignRewardData> Get(int newRewardID)
{
...
public CampaignRewardData Get(int newRewardID,int newOrder)
{
