...
{
public class ArenaGoalRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class ArenaGoalRewardConfig : ConfigBase
{
private static ArenaGoalRewardConfig _instance;
public Dictionary<int, Dictionary<int, ArenaGoalRewardData>> _datas;
public static ArenaGoalRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new ArenaGoalRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("ArenaGoalReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 48;i++)
{
ArenaGoalRewardData data = new ArenaGoalRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, ArenaGoalRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, ArenaGoalRewardData> _dic = new Dictionary<int, ArenaGoalRewardData>();
...
public Dictionary<int, ArenaGoalRewardData> Get(int newRewardID)
{
...
public ArenaGoalRewardData Get(int newRewardID,int newOrder)
{
