...
public partial class ShopConfig : ConfigBase
{
private static ShopConfig _instance;
public Dictionary<int, ShopData> _datas;
...
private void Load()
{
Stream fs = base.Load("Shop.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 3127;i++)
{
...
if (_datas == null)
_datas = new Dictionary<int, ShopData>();
_datas.Add(data.ID,data);
}
br.Close();
fs.Close();
}
public ShopData Get(int newID)
{
