...
{
public class Carnival2RewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class Carnival2RewardConfig : ConfigBase
{
private static Carnival2RewardConfig _instance;
public Dictionary<int, Dictionary<int, Carnival2RewardData>> _datas;
public static Carnival2RewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new Carnival2RewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("Carnival2Reward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 88;i++)
{
Carnival2RewardData data = new Carnival2RewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, Carnival2RewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, Carnival2RewardData> _dic = new Dictionary<int, Carnival2RewardData>();
...
public Dictionary<int, Carnival2RewardData> Get(int newRewardID)
{
...
public Carnival2RewardData Get(int newRewardID,int newOrder)
{
