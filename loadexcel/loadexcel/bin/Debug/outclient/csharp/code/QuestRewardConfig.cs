...
public partial class QuestRewardConfig : ConfigBase
{
private static QuestRewardConfig _instance;
public Dictionary<int, Dictionary<int, QuestRewardData>> _datas;
public static QuestRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new QuestRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("QuestReward.bytes");
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, QuestRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, QuestRewardData> _dic = new Dictionary<int, QuestRewardData>();
...
public Dictionary<int, QuestRewardData> Get(int newRewardID)
{
...
public QuestRewardData Get(int newRewardID,int newOrder)
{
