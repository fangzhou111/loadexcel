...
{
public class ArenaScoreRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class ArenaScoreRewardConfig : ConfigBase
{
private static ArenaScoreRewardConfig _instance;
public Dictionary<int, Dictionary<int, ArenaScoreRewardData>> _datas;
public static ArenaScoreRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new ArenaScoreRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("ArenaScoreReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 7;i++)
{
ArenaScoreRewardData data = new ArenaScoreRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, ArenaScoreRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, ArenaScoreRewardData> _dic = new Dictionary<int, ArenaScoreRewardData>();
...
public Dictionary<int, ArenaScoreRewardData> Get(int newRewardID)
{
...
public ArenaScoreRewardData Get(int newRewardID,int newOrder)
{
