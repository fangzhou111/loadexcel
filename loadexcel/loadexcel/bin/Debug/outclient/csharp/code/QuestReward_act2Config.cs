...
{
public class QuestReward_act2Data
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class QuestReward_act2Config : ConfigBase
{
private static QuestReward_act2Config _instance;
public Dictionary<int, Dictionary<int, QuestReward_act2Data>> _datas;
public static QuestReward_act2Config Instance
{
get
{
if (_instance == null)
{
_instance = new QuestReward_act2Config();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("QuestReward_act2.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 928;i++)
{
QuestReward_act2Data data = new QuestReward_act2Data();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, QuestReward_act2Data>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, QuestReward_act2Data> _dic = new Dictionary<int, QuestReward_act2Data>();
...
public Dictionary<int, QuestReward_act2Data> Get(int newRewardID)
{
...
public QuestReward_act2Data Get(int newRewardID,int newOrder)
{
