...
public partial class HeroStepConfig : ConfigBase
{
private static HeroStepConfig _instance;
public Dictionary<int, Dictionary<int, HeroStepData>> _datas;
public static HeroStepConfig Instance
{
get
{
if (_instance == null)
{
_instance = new HeroStepConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("HeroStep.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 4560;i++)
{
HeroStepData data = new HeroStepData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, HeroStepData>>();
if (!_datas.ContainsKey(data.ID))
{
Dictionary<int, HeroStepData> _dic = new Dictionary<int, HeroStepData>();
...
public Dictionary<int, HeroStepData> Get(int newID)
{
...
public HeroStepData Get(int newID,int newStep)
{
