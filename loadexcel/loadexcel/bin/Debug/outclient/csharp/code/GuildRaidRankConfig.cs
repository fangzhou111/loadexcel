...
{
public class GuildRaidRankData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class GuildRaidRankConfig : ConfigBase
{
private static GuildRaidRankConfig _instance;
public Dictionary<int, Dictionary<int, GuildRaidRankData>> _datas;
public static GuildRaidRankConfig Instance
{
get
{
if (_instance == null)
{
_instance = new GuildRaidRankConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("GuildRaidRank.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 24;i++)
{
GuildRaidRankData data = new GuildRaidRankData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, GuildRaidRankData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, GuildRaidRankData> _dic = new Dictionary<int, GuildRaidRankData>();
...
public Dictionary<int, GuildRaidRankData> Get(int newRewardID)
{
...
public GuildRaidRankData Get(int newRewardID,int newOrder)
{
