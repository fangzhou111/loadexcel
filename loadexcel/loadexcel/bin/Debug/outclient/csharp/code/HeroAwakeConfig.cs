...
public partial class HeroAwakeConfig : ConfigBase
{
private static HeroAwakeConfig _instance;
public Dictionary<int, Dictionary<int, HeroAwakeData>> _datas;
public static HeroAwakeConfig Instance
{
get
{
if (_instance == null)
{
_instance = new HeroAwakeConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("HeroAwake.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 2376;i++)
{
HeroAwakeData data = new HeroAwakeData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, HeroAwakeData>>();
if (!_datas.ContainsKey(data.ID))
{
Dictionary<int, HeroAwakeData> _dic = new Dictionary<int, HeroAwakeData>();
...
public Dictionary<int, HeroAwakeData> Get(int newID)
{
...
public HeroAwakeData Get(int newID,int newAwakeID)
{
