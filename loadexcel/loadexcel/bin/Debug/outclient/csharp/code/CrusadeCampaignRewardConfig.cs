...
{
public class CrusadeCampaignRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class CrusadeCampaignRewardConfig : ConfigBase
{
private static CrusadeCampaignRewardConfig _instance;
public Dictionary<int, Dictionary<int, CrusadeCampaignRewardData>> _datas;
public static CrusadeCampaignRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new CrusadeCampaignRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("CrusadeCampaignReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 799;i++)
{
CrusadeCampaignRewardData data = new CrusadeCampaignRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, CrusadeCampaignRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, CrusadeCampaignRewardData> _dic = new Dictionary<int, CrusadeCampaignRewardData>();
...
public Dictionary<int, CrusadeCampaignRewardData> Get(int newRewardID)
{
...
public CrusadeCampaignRewardData Get(int newRewardID,int newOrder)
{
