...
{
public class WorldBossRewardData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class WorldBossRewardConfig : ConfigBase
{
private static WorldBossRewardConfig _instance;
public Dictionary<int, Dictionary<int, WorldBossRewardData>> _datas;
public static WorldBossRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new WorldBossRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("WorldBossReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 56;i++)
{
WorldBossRewardData data = new WorldBossRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, WorldBossRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, WorldBossRewardData> _dic = new Dictionary<int, WorldBossRewardData>();
...
public Dictionary<int, WorldBossRewardData> Get(int newRewardID)
{
...
public WorldBossRewardData Get(int newRewardID,int newOrder)
{
