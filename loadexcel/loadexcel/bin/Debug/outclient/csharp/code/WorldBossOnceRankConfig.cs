...
{
public class WorldBossOnceRankData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class WorldBossOnceRankConfig : ConfigBase
{
private static WorldBossOnceRankConfig _instance;
public Dictionary<int, Dictionary<int, WorldBossOnceRankData>> _datas;
public static WorldBossOnceRankConfig Instance
{
get
{
if (_instance == null)
{
_instance = new WorldBossOnceRankConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("WorldBossOnceRank.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 15;i++)
{
WorldBossOnceRankData data = new WorldBossOnceRankData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, WorldBossOnceRankData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, WorldBossOnceRankData> _dic = new Dictionary<int, WorldBossOnceRankData>();
...
public Dictionary<int, WorldBossOnceRankData> Get(int newRewardID)
{
...
public WorldBossOnceRankData Get(int newRewardID,int newOrder)
{
