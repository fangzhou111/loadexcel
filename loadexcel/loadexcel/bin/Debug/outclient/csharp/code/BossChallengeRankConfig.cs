...
{
public class BossChallengeRankData
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class BossChallengeRankConfig : ConfigBase
{
private static BossChallengeRankConfig _instance;
public Dictionary<int, Dictionary<int, BossChallengeRankData>> _datas;
public static BossChallengeRankConfig Instance
{
get
{
if (_instance == null)
{
_instance = new BossChallengeRankConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("BossChallengeRank.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 11;i++)
{
BossChallengeRankData data = new BossChallengeRankData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, BossChallengeRankData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, BossChallengeRankData> _dic = new Dictionary<int, BossChallengeRankData>();
...
public Dictionary<int, BossChallengeRankData> Get(int newRewardID)
{
...
public BossChallengeRankData Get(int newRewardID,int newOrder)
{
