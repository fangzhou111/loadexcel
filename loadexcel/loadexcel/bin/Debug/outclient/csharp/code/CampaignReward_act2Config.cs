...
{
public class CampaignReward_act2Data
{
/*奖励ID，主键唯一不可重复*/
public int RewardID; 
/*奖励分组*/
...
public partial class CampaignReward_act2Config : ConfigBase
{
private static CampaignReward_act2Config _instance;
public Dictionary<int, Dictionary<int, CampaignReward_act2Data>> _datas;
public static CampaignReward_act2Config Instance
{
get
{
if (_instance == null)
{
_instance = new CampaignReward_act2Config();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("CampaignReward_act2.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 10756;i++)
{
CampaignReward_act2Data data = new CampaignReward_act2Data();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, CampaignReward_act2Data>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, CampaignReward_act2Data> _dic = new Dictionary<int, CampaignReward_act2Data>();
...
public Dictionary<int, CampaignReward_act2Data> Get(int newRewardID)
{
...
public CampaignReward_act2Data Get(int newRewardID,int newOrder)
{
