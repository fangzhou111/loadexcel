...
public partial class PrisonRewardConfig : ConfigBase
{
private static PrisonRewardConfig _instance;
public Dictionary<int, Dictionary<int, PrisonRewardData>> _datas;
public static PrisonRewardConfig Instance
{
get
{
if (_instance == null)
{
_instance = new PrisonRewardConfig();
_instance.Load();
...
private void Load()
{
Stream fs = base.Load("PrisonReward.bytes");
BinaryReader br = new BinaryReader(fs, System.Text.Encoding.UTF8);
for(int i = 0;i < 5;i++)
{
PrisonRewardData data = new PrisonRewardData();
...
if (_datas == null)
_datas = new Dictionary<int, Dictionary<int, PrisonRewardData>>();
if (!_datas.ContainsKey(data.RewardID))
{
Dictionary<int, PrisonRewardData> _dic = new Dictionary<int, PrisonRewardData>();
...
public Dictionary<int, PrisonRewardData> Get(int newRewardID)
{
...
public PrisonRewardData Get(int newRewardID,int newOrder)
{
